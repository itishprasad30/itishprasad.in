      ...
      <div>
        <section className={clsx("fade-in-start")}>
          <div className="layout min-h-main py-20">
            <h2 className="text-3xl mb-4 font-bold text-center md:text-4xl md:text-left ">
              About
            </h2>
            ...
            <div className="mt-4 flex flex-col md:justify-start md:items-start space-y-10 justify-center items-center ">
              {" "}
              <Image
              ...
              <article className="text-base  mb-3">
                <p className="mb-2">
                  ...
                  course, then started watching a bunch of youtube videos to
                  explore more about web development especially frontend
                  development.
                </p>
                <p className="mb-2">
